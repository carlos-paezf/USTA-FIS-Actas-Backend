...
export class Init1656455060434 implements MigrationInterface {
    name = 'Init1656455060434'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`attached_files\` (\`id\` varchar(36) NOT NULL, \`created_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updated_at\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deleted_at\` timestamp(6) NULL, \`internal_filename\` varchar(255) NOT NULL, \`public_filename\` varchar(255) NOT NULL, \`file_location\` varchar(255) NOT NULL, \`author\` varchar(255) NOT NULL, FULLTEXT INDEX \`IDX_9c7a153d6cf68320f6a94d7a10\` (\`public_filename\`), FULLTEXT INDEX \`IDX_f5fa1cbc0bf37e84ebf3ac423b\` (\`author\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE FULLTEXT INDEX \`IDX_1b03064243f5ad7cf7e33fde36\` ON \`modules\` (\`module_description\`)`);
        await queryRunner.query(`CREATE FULLTEXT INDEX \`IDX_8b95ce6a04657709973209501b\` ON \`permissions\` (\`permission_description\`)`);
        await queryRunner.query(`CREATE FULLTEXT INDEX \`IDX_79e687de8b078c3f6556b93dba\` ON \`roles\` (\`role_description\`)`);
        await queryRunner.query(`CREATE FULLTEXT INDEX \`IDX_51b8b26ac168fbe7d6f5653e6c\` ON \`users\` (\`name\`)`);
        await queryRunner.query(`CREATE FULLTEXT INDEX \`IDX_0408cb491623b121499d4fa238\` ON \`users\` (\`last_name\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_79e687de8b078c3f6556b93dba\` ON \`roles\``);
        await queryRunner.query(`DROP INDEX \`IDX_8b95ce6a04657709973209501b\` ON \`permissions\``);
        await queryRunner.query(`DROP INDEX \`IDX_1b03064243f5ad7cf7e33fde36\` ON \`modules\``);
        ...
        await queryRunner.query(`DROP INDEX \`IDX_f5fa1cbc0bf37e84ebf3ac423b\` ON \`attached_files\``);
